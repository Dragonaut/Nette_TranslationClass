<?php
// source: C:\web\www\translate.local\app/config/config.neon 
// source: C:\web\www\translate.local\app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\\web\\www\\translate.local\\app',
			'wwwDir' => 'C:\\web\\www\\translate.local\\www',
			'debugMode' => TRUE,
			...
			'tempDir' => 'C:\\web\\www\\translate.local\\app/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\\web\\www\\translate.local\\app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=translate.local', 'root', 123456, array('lazy' => TRUE));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\\web\\www\\translate.local\\app/../temp');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('C:\\web\\www\\translate.local\\app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('C:\\web\\www\\translate.local\\app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('C:\\web\\www\\translate.local\\app/../temp/cache', $this->getService('nette.cacheJournal'));
