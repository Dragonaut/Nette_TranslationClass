<?php
// source: C:\web\www\translate.local\app/templates/@layout.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('3607168268', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb68c93b4d86_head')) { function _lb68c93b4d86_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb64c151bdc2_scripts')) { function _lb64c151bdc2_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
